...
{#if open}
	...
	>
		<div
			class="bg-gray-800 border border-gray-700 rounded-xl p-6 w-full max-w-sm mx-4"
		...
		>
			...
			<div class="flex gap-2">
				...
				<button
					onclick={() => { open = false; }}
					class="flex-1 bg-gray-700 hover:bg-gray-600 text-gray-300 text-sm py-2 rounded transition-colors"
				>취소</button>
			</div>
		</div>
	</div>
