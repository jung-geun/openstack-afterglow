<script lang="ts">
	import type { Listener } from '$lib/types/resources';
...
<section class="bg-gray-900 border border-gray-800 rounded-lg p-5 mb-4">
	...
	{#if showAddListener}
		<div class="mb-4 p-4 bg-gray-800/60 border border-gray-700 rounded-lg grid grid-cols-1 sm:grid-cols-3 gap-2">
			...
			<button onclick={handleCreate} disabled={saving} class="col-span-2 bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 text-white text-sm px-3 py-2 rounded">생성</button>
