...
<div class="flex flex-col gap-3.5">
	<a href="/admin/containers" class="bg-gray-900 border border-gray-800 rounded-2xl p-[18px] flex items-center gap-3.5 hover:border-amber-500/40 hover:bg-gray-800 transition-colors">
	...
	<a href="/admin/file-storage" class="bg-gray-900 border border-gray-800 rounded-2xl p-[18px] flex items-center gap-3.5 hover:border-teal-500/40 hover:bg-gray-800 transition-colors">
	...
	<a href="/admin/database-instances" class="bg-gray-900 border border-gray-800 rounded-2xl p-[18px] flex items-center gap-3.5 hover:border-cyan-500/40 hover:bg-gray-800 transition-colors">
	...
	<a href="/admin/object-storage" class="bg-gray-900 border border-gray-800 rounded-2xl p-[18px] flex items-center gap-3.5 hover:border-indigo-500/40 hover:bg-gray-800 transition-colors">
