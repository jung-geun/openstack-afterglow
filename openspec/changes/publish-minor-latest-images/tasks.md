...
- [ ] Commit and push both development branches and open dev-to-main release pull requests.
- [ ] After the required manual main merges, create the annotated Afterglow `v1.18.0` tag from the main merge commit.
