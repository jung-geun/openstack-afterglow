...
- [x] Identify existing Afterglow frontend-origin configuration consumers.
- [x] Add the explicit public endpoint variable and render it to frontend-facing configuration.
