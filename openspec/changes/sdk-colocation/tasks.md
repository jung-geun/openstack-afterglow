...
- [ ] Regenerate and publish service subtree branches, then pin backend SDK dependencies and `backend/uv.lock` to released service-repository subdirectories.
- [ ] Verify clean SDK installation from each published service repository and run the required repository test/lint gate.
