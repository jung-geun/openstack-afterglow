...
def _render_toml_for_k8s(cfg: dict) -> str:
    ...
    lines.append(f"logo_dark_path = {_toml_str(app.get('logo_dark_path', '/logo-dark.png'))}")
    lines.append(f"logo_light_path = {_toml_str(app.get('logo_light_path', '/logo-white.png'))}")
