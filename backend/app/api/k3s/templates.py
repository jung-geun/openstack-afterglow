...
from app.models.k3s import CreateK3sClusterTemplateRequest, K3sClusterTemplateInfo, UpdateK3sClusterTemplateRequest
from app.services import k3s_template as _svc
