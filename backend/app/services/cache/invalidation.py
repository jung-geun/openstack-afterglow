...
from app.services.cache.keys import mutcount_key, version_key
...
async def invalidate_tag(tag: str) -> int:
    ...
    from app.services.cache import _get_backend  # 지연 임포트로 순환 방지
...
async def bump_version(service: str, project_id: str) -> int:
    ...
    """
    from app.services.cache import _get_backend
