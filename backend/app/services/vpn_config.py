...
# 서버 이름은 이미 VpnServerCreateRequest 에서 화이트리스트 검증되지만, cloud-init
...
def render_agent_userdata(
    *,
    ...
    """VPN 에이전트 cloud-init YAML을 렌더하고 base64 인코딩해 반환한다.
    ...
    yaml_str = _jinja.get_template("vpn_agent.yaml.j2").render(
