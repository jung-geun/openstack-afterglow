...
from app.models.vpn import VpnAgentStatusReport

_logger = logging.getLogger(__name__)

_TOKEN_PREFIX = "afterglow:vpn:token:"
_SERVER_PREFIX = "afterglow:vpn:server:"
_STATUS_PREFIX = "afterglow:vpn:status:"
...
async def store_status_result(server_id: str, report: VpnAgentStatusReport) -> None:
