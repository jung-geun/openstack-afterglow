...
from app.services import neutron, nova, waygate_agent_auth, waygate_config, waygate_db
...
async def provision_waygate_server(
    ...
    try:
        ...
        register_url = f"{callback_base}/api/v1/waygate/servers/{server_id}/agent/register"
        desired_state_url = f"{callback_base}/api/v1/waygate/servers/{server_id}/agent/desired-state"
        status_url = f"{callback_base}/api/v1/waygate/servers/{server_id}/agent/status"
