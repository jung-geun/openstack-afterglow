...
검증 대상:
- k3s_crypto.encrypt/decrypt_chat_content: v3 왕복, v3 prefix, 평문 passthrough(하위호환), None 안전, 도메인 분리
...
class TestChatContentCrypto:
    ...
    def test_cross_domain_not_decryptable(self, valid_key):
        ...
        from app.services.k3s_crypto import decrypt_llm_provider_key, encrypt_chat_content
