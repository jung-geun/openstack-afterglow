...
import app.services.chat.provider_store as provider_store
from app.services.chat.capabilities import litellm_capabilities, normalize_capabilities
from app.services.chat.provider_store import (
    _model_public,
...
def test_image_input_is_disabled_when_the_scanned_asset_pipeline_is_unavailable(monkeypatch):
    ...
    monkeypatch.setattr("app.services.chat.assets.asset_pipeline_available", lambda: False)
