...
from app.api.chat import assets as asset_api
from app.api.deps import get_token_info
from app.services.chat import assets
...
def test_inspector_runs_fixed_argv_with_resource_limited_child(tmp_path: Path, monkeypatch):
    ...
    assert captured["argv"] == [assets.sys.executable, "-m", "app.services.chat.asset_inspector", str(path)]
