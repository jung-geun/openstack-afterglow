...
@pytest.mark.asyncio
async def test_gpu_count_detects_by_original_name(admin_client, mock_conn, monkeypatch):
...
@pytest.mark.asyncio
async def test_gpu_count_detects_by_pci_alias(admin_client, mock_conn, monkeypatch):
...
@pytest.mark.asyncio
async def test_gpu_count_ignores_audio_pci_alias(admin_client, mock_conn, monkeypatch):
...
@pytest.mark.asyncio
async def test_gpu_count_zero_for_cpu_flavor(admin_client, mock_conn, monkeypatch):
...
@pytest.mark.asyncio
async def test_microversion_header_sent(admin_client, mock_conn, monkeypatch):
